...
def extract_all():
  for subject_id in tqdm(subjects, ascii=True):
      ...
      extract_tgz('archives/Poses_D3_Angles_mono_{}.tgz'.format(subject_id),
                  path.join(out_dir, 'Poses_D3_Angles_mono')),
      extract_tgz('archives/BBox_{}.tgz'.format(subject_id),
